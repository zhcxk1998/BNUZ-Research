  ...
  <div className="footer__container">
    <div className="footer__wrap">
      <div className="service__wrap wrap">
        ...
        <Link className="link" to="#">研学服务</Link>
        <Link className="link" to="#">新闻资讯</Link>
        <Link className="link" to="#">研学APP</Link>
      </div>
      <div className="help__wrap wrap">
        ...
        <Link className="link" to="#">研学发布规则</Link>
    ...
    <div className="copyright">
      Copyright © 2019 师大研学 粤ICP备1231232号
    </div>
  </div>
)
